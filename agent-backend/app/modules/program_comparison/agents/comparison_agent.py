"""
Comparison presenter — the module's only LLM step.
...
Prompt rules follow the chatbot's comparison specialist: never rank
programmes, keep every number exactly as given, attribute competitor facts
to that university's own published sources.
"""
...
# Headroom above the visible JSON for Kimi's hidden reasoning budget. The
# full answer is large (dimensions x programmes cells + comments + summary):
# 5000 proved too small in testing — the JSON got truncated mid-string.
_MAX_TOKENS = 12000
