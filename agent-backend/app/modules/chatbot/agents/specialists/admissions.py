...
application process, eligibility, and deadlines. Soft-boosted toward the
"admissions" topic (see app/services/rag_service.py::_topic_of) rather than
hard-filtered, since admissions-adjacent content can live in other tables
too and a hard filter risks losing recall. See
app/modules/chatbot/agents/specialists/assessment.py for the personalised
Application Readiness Assessment node, which shares OFFICIAL_SOURCES with
this module.
"""
