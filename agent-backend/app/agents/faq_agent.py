...
app/rag/retriever.py::_topic_of. Boosted rather than filtered because these
snippets can touch on any topic, so hard-restricting risks losing relevant
chunks that live in other tables.
"""
