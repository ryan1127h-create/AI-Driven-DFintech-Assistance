...
Soft-boosted toward the "financial" topic (see
app/services/rag_service.py::_topic_of) rather than hard-filtered, since
financial-adjacent content can live in other tables too and a hard filter
risks losing recall.
"""
