...
modules (chatbot, once the supervisor integration round happens) are allowed
to import from app.modules.course_recommendation. Everything else in this
package (repository, rule engine, agent, service internals) is private.
