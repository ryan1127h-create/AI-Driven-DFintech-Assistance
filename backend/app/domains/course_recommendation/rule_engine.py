...
actually recommend is the LLM's choice (recommendation_agent.py), picked
strictly from this pool. score_candidates() below is only the fallback
ranking used when the LLM is unavailable.
