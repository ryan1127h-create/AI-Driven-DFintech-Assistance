"""Internal domain models for course_recommendation — structured views of
the knowledge base's courses / career_roles / course_rules chunks (see
repository.py for how raw chunks are parsed into these)."""
...
class CareerRole:
    ...
    line up 1:1 with the profile domain's TARGET_ROLE_VALUES."""
    role_id: str
    role_title: str
