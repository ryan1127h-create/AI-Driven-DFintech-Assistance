"""Internal domain models for program_comparison — structured views of the
knowledge base's competitor_programs chunks and the NUS-side programme
pages (see repository.py for how they are built)."""
